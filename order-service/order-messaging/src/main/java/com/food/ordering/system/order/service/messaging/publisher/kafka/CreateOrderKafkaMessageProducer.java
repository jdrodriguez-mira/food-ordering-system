...
public class CreateOrderKafkaMessageProducer implements OrderCreatedPaymentRequestMessagePublisher {
    ...
    public CreateOrderKafkaMessageProducer(OrderMessagingDataMapper orderMessagingDataMapper, OrderServiceConfigData orderServiceConfigData, KafkaProducer<String, PaymentRequestAvroModel> kafkaProducer, OrderKafkaMessageHelper orderKafkaMessageHelper) {
